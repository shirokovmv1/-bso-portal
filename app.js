    ...
    news: [
        {
            id: 1,
            date: '2026-01-13',
            title: 'Добро пожаловать на корпоративный портал!',
            text: 'Теперь вся важная информация компании доступна в одном месте.'
        },
        {
            id: 2,
            date: '2026-01-10',
            title: 'Обновление системы документооборота',
            text: 'С 15 января вступают в силу новые правила оформления заявок.'
        }
    ],
    events: [
        {
            ...
            text: 'Общее собрание сотрудников в конференц-зале в 14:00'
        },
        {
            id: 2,
            date: '2026-01-25',
            title: 'Тренинг по кибербезопасности',
            text: 'Обязательный тренинг для всех сотрудников'
        }
    ],
    applications: [
        {
